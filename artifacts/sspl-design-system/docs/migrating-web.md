# Migrating web UI to SSPL Design System

Read `artifacts/sspl-design-system/docs/AGENTS.md` and
`artifacts/sspl-design-system/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/sspl-design-system/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/sspl-design-system/lib/utils`
- `@/hooks/use-toast` → `@workspace/sspl-design-system/hooks/use-toast`
