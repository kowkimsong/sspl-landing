# Consuming SSPL Design System in Expo apps

Read `artifacts/sspl-design-system/docs/AGENTS.md` first. React Native does
...
`artifacts/sspl-design-system/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/sspl-design-system/tokens";
...
```tsx
import { nativeTheme } from "@workspace/sspl-design-system/lib/native-theme";
import { useColors } from "@workspace/sspl-design-system/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/sspl-design-system/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/sspl-design-system/components/native/badge";
import { Button } from "@workspace/sspl-design-system/components/native/button";
import { Card } from "@workspace/sspl-design-system/components/native/card";
```
...
Import and render
`@workspace/sspl-design-system/components/native/button`, then run Expo
