# Consuming SSPL Design System in web apps

Read `artifacts/sspl-design-system/docs/AGENTS.md` first. This guide covers
...
`artifacts/sspl-design-system/docs/migrating-web.md` before writing UI.
...
```css
@import "@workspace/sspl-design-system/styles.css";
```
...
`node_modules/@workspace/sspl-design-system/src/components` to `content`.
...
```tsx
import { Button } from "@workspace/sspl-design-system/components/ui/button";
import { cn } from "@workspace/sspl-design-system/lib/utils";
import {
  toast,
  useToast,
} from "@workspace/sspl-design-system/hooks/use-toast";
```
...
`@workspace/sspl-design-system/components/ui/button`. Run the app's typecheck
