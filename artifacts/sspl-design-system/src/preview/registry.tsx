...
export const DESIGN_SYSTEM = {
  title: 'SSPL Design System',
  description:
    'Visual language for the Singapore Seniors Pickleball League — deep navy authority, pickleball-yellow accent, Playfair Display headings, Source Sans 3 body. Built for credibility, sponsorship appeal, and senior readability.',
} as const;

export const OVERVIEW_ENTRY: PreviewEntry = {
  id: 'overview',
  name: 'Overview',
  description: 'Foundations and principles of the SSPL visual identity.',
  Page: OverviewPage,
};
